# cascade kullanrak tespit algoritması
...
# trackbar
"""
- detectMultiScale fonksiyonu içindeki değerleri değiştirebilmek
için buyarı yazıyoruz. tespitleri daha doğru yapmak için değerlerle oynuyoruz
